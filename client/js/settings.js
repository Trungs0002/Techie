...
function loadAvatars() {
  ...
  const avatarFiles = [
    ...
    { name: "avatar_1", file: "avatar_1.png" },
    { name: "avatar_2", file: "avatar_2.png" },
    { name: "avatar_3", file: "avatar_3.png" },
    { name: "avatar_4", file: "avatar_4.png" },
    { name: "avatar_5", file: "avatar_5.png" },
    { name: "avatar_6", file: "avatar_6.png" },
    { name: "avatar_7", file: "avatar_7.png" },
    { name: "avatar_8", file: "avatar_8.png" },
    { name: "avatar_9", file: "avatar_9.png" },
    { name: "avatar_10", file: "avatar_10.png" },
    { name: "avatar_11", file: "avatar_11.png" },
    { name: "avatar_12", file: "avatar_12.png" },
    { name: "avatar_13", file: "avatar_13.png" },
    { name: "avatar_14", file: "avatar_14.png" },
    { name: "avatar_15", file: "avatar_15.png" },
    { name: "avatar_16", file: "avatar_16.png" },
  ];
